    ...
    return (
        <div className="h-full flex flex-col p-6 w-full max-w-[1700px] mx-auto space-y-6">
            <div className="flex items-center justify-between shrink-0">
                <div>
                    <h1 className="text-3xl font-bold bg-gradient-to-r from-red-400 via-primary to-purple-400 bg-clip-text text-transparent drop-shadow-sm">
                        Phân tích hiệu suất
                    </h1>
                ...
                <div className="flex items-center gap-4 text-sm font-mono text-zinc-300 bg-zinc-900/80 p-3 px-6 rounded-2xl border border-white/5 shadow-inner">
                    <span>Tổng Nhân Sự Đánh Giá: <strong className="text-primary-accent">{analyticsData.length}</strong></span>
                </div>
            </div>
