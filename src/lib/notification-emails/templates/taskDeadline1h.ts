...
export async function taskDeadline1h(params: TaskDeadlineParams): Promise<RenderedEmail> {
...
<p style="margin:14px 0 0 0;color:${COLORS.DANGER};font-size:14px;font-weight:600;">Task sắp hết hạn! Nếu cần thêm thời gian, hãy liên hệ manager ngay.</p>`
...
${ctaRow(buttons)}`
    ...
    return {
        subject: `⚠️ Deadline còn 1 giờ: "${params.taskTitle}"`,
        html,
    }
}
