                ...
                >
                    {node.hasChildren ? (
                        <button
                            ...
                            // w-6 not w-5: 20px wide fails WCAG 2.2 SC 2.5.8 (24x24 min). Same tree
                            // toggle as TeamBrowser — keep the two in step.
                            className="flex h-7 w-6 items-center justify-center text-muted-foreground hover:text-zinc-200"
