            ...
            <div style={{ position: 'relative', flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
                ...
                <div style={{ flex: 1, overflowY: 'auto', padding: '20px 24px', minHeight: 0 }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(300px,1fr))', gap: 14 }}>
                        ...
                        {/* Invite CTA card */}
                        <button type="button" onClick={() => setInviteOpen(true)} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 10, minHeight: 220, borderRadius: 20, border: '1.5px dashed rgba(255,255,255,0.14)', background: 'transparent', color: '#71717A', cursor: 'pointer' }}>
