...
export function ForwardMessageDialog({ isOpen, onClose, messageId, messagePreview }: ForwardMessageDialogProps) {
    ...
    return (
        ...
        >
            <div className="w-[calc(100vw-1rem)] sm:w-[420px] max-h-[80dvh] sm:max-h-[70vh] bg-zinc-900/95 backdrop-blur-2xl rounded-2xl border border-white/[0.08] shadow-[0_24px_60px_rgba(0,0,0,0.5)] flex flex-col overflow-hidden">
                {/* Header */}
