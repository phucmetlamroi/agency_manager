            ...
            {isOpen && task && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed top-0 right-0 w-full md:w-[600px] h-full bg-zinc-950/90 border-l border-white/10 z-50 shadow-2xl flex flex-col backdrop-blur-3xl overflow-y-auto custom-scrollbar"
                    >
                        {/* Header */}
                        <div className="sticky top-0 bg-zinc-950/80 backdrop-blur-xl border-b border-white/5 p-6 flex items-start justify-between z-10">
                        ...
                        <div className="p-6 space-y-8 flex-1">
                            ...
                            {/* Rating Survey embedded directly in drawer */}
