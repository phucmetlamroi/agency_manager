                ...
                <div className="fixed inset-0 z-[100] flex justify-end">
                    ...
                    <div className="relative w-4/5 max-w-[300px] bg-[#1a1a1a] h-full shadow-2xl border-l border-white/10 animate-slide-in-right p-6 flex flex-col">
                        ...
                        <div className="flex-1 flex flex-col gap-2">
                            ...
                            <Link href="/workspace" onClick={() => setIsDrawerOpen(false)} className="w-full text-left px-4 py-3 rounded-xl bg-blue-500/10 hover:bg-blue-500/20 text-blue-400 transition-colors flex items-center gap-3 border border-blue-500/20">
